...
, is: [`an exploration of xml via
       ...
       `inserting $'s between
        ...
        each tag's name & closing
        > bracket
       `,
       `replacing leading <'s &
        trailing >'s with /'s
       `,
       `wrapping xml text content
        with a -[ prefix and ]-
        postfix.
       `
      ],
  we: [ "must ..."
      ...
      , "want ..."
      , "love ..."
      , "like this for non-web js environments like node.js"
      , "know that web views can already import xml to js"
      , "wish ..."
      , "cant ..."
      , "wont ..."
      ]
